        ...
        <div class="display_form">
            ...
            <form action="form_export.php" method="POST" enctype="multipart/form-data">
                ...
                <table class="export_form">
                    ...
                    <tr>
                        <td>Address*</td>
                        <td><input type="text" name="addres" placeholder="Addres" required
                                value="<?php echo $export_addres; ?>"></td>
                        <td>E-mail address* </td>
                        <td><input type="email" name="email" required value="<?php echo $export_email; ?>"></br></td>
                    </tr>
                    <tr>
                        <td>City*</td>
                        <td><input type="text" name="city" placeholder="City" required
                                value="<?php echo $export_city; ?>"></td>
                    ...
                    <tr>
                        <td>Postal code* </td>
                        <td> <input type="text" name="postal_code" placeholder="Postal code" required
                                value="<?php echo $export_postal_code; ?>"></td>
                    </tr>
                    <tr>
                        <td>Street*</td>
                        <td><input type="text" name="street" placeholder="Street" required
                                value="<?php echo $export_street; ?>"></td>
                    </tr>
                    <tr>
                        <td>Number*</td>
                        <td> <input type="text" name="number" placeholder="Number" required
                                value="<?php echo $export_number; ?>"></td>
                    </tr>
                    <tr>
                        <td>Country*</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="registration_number"
                                placeholder="This will be id of this transport" required size="40"
                ...
                <table class="export_form">
                    <thead>
                        <tr>
                            ...
                            <th></th>
                            <th>
                                <h2>Transit customs office number</h2>
                            </th>
                        </tr>
                    </thead>
                    <tr>
                        <td>Departure customs office usual name*</td>
                        <td><input type="text" name="dep_office_usual_name" required
                                value="<?php echo $export_departure_name; ?>"></td>
                        <td>Transit customs office usual name*</td>
                        <td><input type="text" name="tras_office_usual_name" required
                                value="<?php echo $export_transport_name; ?>"></td>
                    </tr>
                    <tr>
                        <td>Departure customs office number*</td>
                        <td><input type="text" name="dep_office_number" required
                                value="<?php echo $export_departure_number; ?>"></td>
                        <td>Transit customs office number*</td>
                        <td><input type="text" name="trans_office_number" required
                                value="<?php echo $export_transport_number; ?>"></td>
                    </tr>
                    <tr>
                ...
                <table class="export_form">
                    ...
                    <tr>
                        <td><input type="datetime-local" name="arrival_date_at_customs_import"
                                value="<?php echo $export_date_driver_arrival; ?>"></td>
                    </tr>
                </table>

                </br>
                <h3>Do you require T1 to be issued for this export*</h3><br>
                <input type="radio" name="T1" value="yes" checked>Yes
                <input type="radio" name="T1" value="no">No<br>


                <table class="export_form">
                    <tr>
                        <td>Country of origin*</td>
                        <td><input type="text" name="country_of_origin" required
                                value="<?php echo $export_country_of_origin; ?>"></td>
                        <td>Commodity code*</td>
                        <td><input type="text" name="commodity_code" required
                                value="<?php echo $export_commodity_code; ?>"></td>
                    </tr>
                    <tr>
                        <td>Description of goods*</td>
                        <td> <textarea name="description_of_good" cols="50" rows="4" style="resize:none;"
                                value="<?php echo $export_description_of_good; ?>"></textarea></td>
                        <td>Packages type*</td>
                        <td>
                            <input type="radio" name="packages_type" value="cartons" checked>Cartons
                    ...
                    <tr>
                        <td>Net weight(kg)*</td>
                        <td><input type="text" name="net_weight" required value="<?php echo $export_net_weight; ?>">
                        </td>
                        <td>Gross weight(kg)*</td>
                        <td><input type="text" name="gross_weight" required value="<?php echo $export_gross_weight; ?>">
                        </td>
                    </tr>
                    <tr>
                        <td>Item value*</td>
                        <td><input type="text" name="item_value" value="<?php echo $export_item_value; ?>"></td>
                        <td>Currency*</td>
                        <td>
                    ...
                    <tr>
                        <td>Quantity*</td>
                        <td><input type="text" name="quantity" required value="<?php echo $export_quantity; ?>"></td>
                    </tr>
                </table>
                ...
                <table class="export_form">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="total_packages" required
                                value="<?php echo $export_total_packages; ?>"></td>
                        <td>Total net weight*</td>
                        <td> <input type="text" name="total_net_weight" required
                                value="<?php echo $export_total_net_weight; ?>"></td>
                    </tr>
                    <tr>
                        <td>Total gross weight*</td>
                        <td><input type="text" name="total_gross_weight" required
                                value="<?php echo $export_total_gross_weight; ?>"></td>
                        <td>Invoice number*</td>
                        <td><input type="text" name="invoice_number" required
                                value="<?php echo $export_invoice_number; ?>"></td>
                    </tr>
                    <tr>
                        <td>Total value*</td>
                        <td><input type="text" name="total_value" required value="<?php echo $export_total_value; ?>">
                        </td>
                    ...
                    <tr>
                        ...
                        <td><textarea name="additional_notes" cols="50" rows="4" style="resize:none;"
                                value="<?php echo $export_additional_notes; ?>"></textarea></td>
                        <td>Incotemrs*</td>
                        <td><input type="text" name="incoterms" required value="<?php echo $export_incoterms; ?>"></td>
